...
from ytsum.domain import Provenance, SourceIdentity, SourceKind, Transcript, TranscriptSegment
...
class WhisperProvider:
    ...
    async def fetch(self, source: SourceIdentity, language: str) -> Transcript | None:
        ...
        with tempfile.TemporaryDirectory(dir=self.temporary_root, prefix="ytsum-audio-") as raw:
