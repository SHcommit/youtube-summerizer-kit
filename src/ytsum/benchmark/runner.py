...
def live_benchmark_spec(
    ...
    *,
    ...
    from ytsum.core.identity import normalize_youtube_url
    from ytsum.core.models import GenerationRequest
    from ytsum.core.prompts import PROMPT_FINGERPRINT
    from ytsum.harness.builtin import request_prompt
    ...
    def hierarchical(runtime_id: str) -> ConditionRunner:
        ...
        async def observe(_: str) -> BenchmarkObservation:
            ...
            started = monotonic()
            with tempfile.TemporaryDirectory(prefix="ytsum-benchmark-") as temporary:
                root = Path(temporary)
