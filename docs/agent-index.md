...
| 7 | `src/chew/retention/` | Storage retention policy planner and cleaner |
| 8 | `src/chew/benchmark/` | Quality benchmarking runner and comparison reports |
| 9 | `src/chew/cli/` | Typer CLI (bilingual Korean/English), `chew serve` health server launcher |
...
| `benchmarks/reference-drafts/` | AI-assisted, non-executable review queues for human benchmark-reference approval; never pass these Markdown files to `--reference` |
