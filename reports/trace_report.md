...
| :--- | :--- | :--- | :--- | :--- |
| `chew.transcript_acquisition` | 1.9 ms | +0.0 ms | OK | source: https://www.youtube.com/watch?v=abcDEF_1234 |
| `chew.segmentation` | 0.1 ms | +1.9 ms | OK | raw_chapters: 0, selected_chapters: 0 |
| `chew.dag_scheduler` | 21.9 ms | +5.7 ms | OK | total_jobs: 3, concurrency: 2, runtime: fake |
