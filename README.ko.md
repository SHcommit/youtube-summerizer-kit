...
YouTube 영상과 로컬 오디오·영상 파일을 단순히 한 번 요약하는 데서 끝내지 않고, transcript를
검증하고 소주제별로 병렬 분석한 뒤 여러 형태로 재조립하는 로컬 우선 지식 정리 CLI입니다.

- 긴 영상도 챕터·소주제 단위로 나눠 병렬 처리합니다.
- 중간에 네트워크나 AI CLI가 끊겨도 완료된 작업부터 이어갑니다.
